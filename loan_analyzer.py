...
total_amount_all_loans = sum(loan_costs)
print(f"The total value of the loans is {total_amount_all_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
average_loan_price = total_amount_all_loans / total_number_of_loans
...
discount_rate = .20
r = discount_rate
present_value = future_value / (1 + (r/12)) ** remaining_months
...
# YOUR CODE HERE!
with open(output_path, 'w') as inexpensive_loans.csv:
        csvwriter = csv.writer(inexpensive_loans.csv)

        csvwriter.writerow(header)
        for row in inexpensive_loans:
            csvwriter.loan.values()
